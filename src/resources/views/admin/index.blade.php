...
<div class="admin">
    ...
    {{-- エクスポート --}}
        <div class="admin__actions">
            <a href="{{ route('admin.export', request()->query()) }}" class="admin__export">エクスポート</a>
                    ...
                    @foreach ($contacts as $contact)
                        <dialog class="modal" id="modal-{{ $contact->id }}">
                            ...
                            <div class="modal__panel">
                                <button type="button" class="modal__close-wrap" aria-label="close" onclick="document.getElementById('modal-{{ $contact->id }}').close()">
    ...
    {{-- ★リスト本体 --}}
        ...
        <form action="{{ route('contact.delete', $contact) }}" method="post" class="modal__delete-wrap">
            @csrf
            @method('DELETE')
